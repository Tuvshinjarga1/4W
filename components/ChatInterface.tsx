              ...
              <div className="flex items-start gap-2 max-w-[80%]">
                ...
                >
                  {editingId === message.id ? (
                    <form onSubmit={(e) => { e.preventDefault(); handleEditMessage(message.id!); }} className="flex gap-2">
                      <Input
                        value={editingText}
                    ...
                    <>
                      ...
                      <div className="flex gap-1 mt-1">
                        <Button size="sm" variant="ghost" onClick={() => { setEditingId(message.id!); setEditingText(message.text); }}><Edit2 className="w-3 h-3" /></Button>
                        <Button size="sm" variant="ghost" onClick={() => handleDeleteMessage(message.id!)}><Trash2 className="w-3 h-3" /></Button>
                      </div>
                    </>
                  )}
                </div>
